...
var TAB_BUTTON = document.querySelectorAll('.subscription__nav-button');
var TAB_NAV = document.querySelector('.subscription__nav');
var TAB_CONTENT = document.querySelectorAll('.subscription__subcontent');
var SUB_TITLE = document.querySelectorAll('[data-sub-title]');
function hideTabContent(tab) {
  for (var i = tab; i < TAB_CONTENT.length; i++) {
