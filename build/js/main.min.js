...
/* harmony import */ var _modules_video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/video */ "./js/modules/video.js");
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/tabs */ "./js/modules/tabs.js");
/* harmony import */ var _vendor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor */ "./js/vendor.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_1__["scrollPage"])();
  Object(_modules_video__WEBPACK_IMPORTED_MODULE_2__["addIframe"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["onClickTab"])();
  Object(_vendor__WEBPACK_IMPORTED_MODULE_4__["swipeCoachSwiper"])();
  Object(_vendor__WEBPACK_IMPORTED_MODULE_4__["swipeReviewsSwiper"])();
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_5__["inputFormTel"])();
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_5__["inputFormName"])();
...
/*!****************************!*\
  !*** ./js/modules/form.js ***!
  \****************************/
/*! exports provided: inputFormTel, inputFormName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "inputFormTel", function() { return inputFormTel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "inputFormName", function() { return inputFormName; });
function inputFormTel() {
  var INPUT_TEL = document.querySelectorAll('input[type="tel"]');
  INPUT_TEL.forEach(function (item) {
    item.addEventListener('input', function () {
      var value = item.value.replace(/[^0-9\s)(+\-]/g, ''); // ограничивает ввод всех символов кроме указанных
...
function inputFormName() {
  var INPUT_NAME = document.querySelectorAll('input[type="text"]');
  INPUT_NAME.forEach(function (item) {
    item.removeAttribute('pattern');
    item.addEventListener('input', function () {
      var value = item.value.replace(/[^a-zA-ZА-Яа-яЁё'\-\s]/gi, '');
      var nameLength = 100;
      var result = '';
      for (var i = 0; i < value.length && i < nameLength; i++) {
        result += value[i];
      }
      item.value = result;
    });
...
var ANCHOR = document.querySelectorAll('a[data-anchor]');
function scrollPage() {
  var _iterator = _createForOfIteratorHelper(ANCHOR),
    _step;
  try {
...
/*!****************************!*\
  !*** ./js/modules/tabs.js ***!
  \****************************/
/*! exports provided: onClickTab */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onClickTab", function() { return onClickTab; });
var TAB_BUTTONS = document.querySelectorAll('[data-sub-button]');
var TAB_CONTENTS = document.querySelectorAll('[data-sub-tab]');
var TAB_NAVIGATION = document.querySelector('[data-sub-nav]');
var SUB_TITLE = document.querySelectorAll('[data-sub-title]');
var removeNoJS = function removeNoJS(elements) {
  elements.forEach(function (elem) {
    elem.classList.remove('no-js');
  });
};
var addClassOnElements = function addClassOnElements(targetButton) {
  var currentId = targetButton.getAttribute('data-button-id');
  var currentTab = document.querySelector("[data-tab='".concat(currentId, "']"));
  if (!targetButton.classList.contains('subscription__nav-button--active')) {
    TAB_BUTTONS.forEach(function (elem) {
      elem.classList.remove('subscription__nav-button--active');
    });
    TAB_CONTENTS.forEach(function (elem) {
...
var VIDEO_BUTTON = VIDEO ? VIDEO.querySelector('[data-video-button]') : null;
...
/*!**********************!*\
  !*** ./js/vendor.js ***!
  \**********************/
/*! exports provided: swipeCoachSwiper, swipeReviewsSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swipeCoachSwiper", function() { return swipeCoachSwiper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swipeReviewsSwiper", function() { return swipeReviewsSwiper; });
...
var COACHES_SWIPER = document.querySelector('.coaches__wrapper');
var COACHES_LIST = document.querySelector('.coaches__list');
var COACHES_BUTTONS = document.querySelectorAll('.coaches__button');
var REVIEWS_SWIPER = document.querySelector('.reviews__wrapper');
var REVIEWS_LIST = document.querySelector('.reviews__list');
var REVIEWS_BUTTONS = document.querySelectorAll('.reviews__button');
function deleteTabindex() {
  var SLIDES_DUPLICATE = document.querySelectorAll('.swiper-slide-duplicate');
  SLIDES_DUPLICATE.forEach(function (slide) {
...
var swipeCoachSwiper = function swipeCoachSwiper() {
  deleteClassNoJS(COACHES_LIST, COACHES_BUTTONS);
  if (COACHES_SWIPER) {
    var swiper = new Swiper(COACHES_SWIPER, {
...
var swipeReviewsSwiper = function swipeReviewsSwiper() {
